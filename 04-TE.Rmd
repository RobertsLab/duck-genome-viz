...
```{bash}
head -4 feature-tracks/Panopea-generosa-vv0.74.a4.repeats.LINE.gff3
```
...
write_delim(file, "feature-tracks/Pg_00.a4.repeats.LINE.gff3", delim = "\t", col_names = FALSE)





a4_LINE = import("feature-tracks/Pg_00.a4.repeats.LINE.gff3")
...
```{bash}
head feature-tracks/Pg_00.a4.repeats.LINE.gff3
...
#kpPlotRegions(kp, a4_LINE, col="red", data.panel=1, r0=NULL, r1=NULL, avoid.overlapping = FALSE, num.layers = NULL)
